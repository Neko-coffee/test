...
class CmtTransformer(BaseModule):
    ...
    def forward(self, x, x_img, query_embed, bev_pos_embed, rv_pos_embed, attn_masks=None, attention_bias=None, reg_branch=None):
        ...
        Args:
            ...
            attention_bias (Tensor): Attention bias for cross-attention, with shape
                [bs, num_query, num_features]. Default: None.
        Returns:
        ...
        # 🔥 处理attention_bias维度转换
        # 输入: [bs, num_query, num_features]
        # 需要: [num_query, bs, num_features] (与query维度匹配)
        if attention_bias is not None:
            attention_bias = attention_bias.transpose(0, 1)  # [bs, num_query, num_features] -> [num_query, bs, num_features]
        ...
        out_dec = self.decoder(
            ...
            attention_bias=attention_bias,  # 🔥 传递给PETRMultiheadAttention，它会自动合并到attn_mask
